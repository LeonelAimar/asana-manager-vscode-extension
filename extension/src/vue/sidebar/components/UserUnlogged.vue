<template>
    <div class="containerUnlogged flex-center-column mt-2">
        <Key :width="64" :height="64" />
        <h1>It seems you're not authenticated with Asana</h1>
        <button 
            @click="methods.postMessage(POST_MESSAGES.AUTH_BEGIN)"
            class="mt-2"
        >
